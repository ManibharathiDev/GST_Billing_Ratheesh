...
<html>
	...
	<body>
			...
			<div class="wrap-content">
				<div class="row">
					...
					<div class="col-md-2 padding-left">
						<a href="#" id="newUser" class="wrap-btn-new"><i class="fa fa-plus" aria-hidden="true"></i> New User</a>
					</div>
		...
		<?php
			include('footer.php');
		?>
	<div class="modal fade" id="wrapModel" role="dialog">
        ...
        <div class="modal-body">
			...
			<form name="userForm" id="userForm">
				<div class="row wrap-margin">
					...
					<div class="col-md-7">
						<input type="text" name="userName" class="wrap-text cinput" required>
					</div>
				</div>
				<div class="clear"></div>
				<div class="row wrap-margin">
					...
					<div class="col-md-7">
						<input type="text" name="userId" class="wrap-text cinput userId" required>
						<div class="errMsg" id="errorUserId">User ID Already Exists!</div>
					</div>
				</div>
				<div class="clear"></div>
				<div class="row wrap-margin">
					...
					<div class="col-md-7">
						<input type="text" name="userPass" class="wrap-text cinput" required>
					</div>
				</div>
				<div class="clear"></div>
				<div class="row wrap-margin">
					...
					<div class="col-md-7">
						<select name="userStatus" class="wrap-text cinput" required>
