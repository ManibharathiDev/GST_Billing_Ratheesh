			...
			$(document).ready(function(){
							...
							content += '<table class="table table-bordered customTable">';
								...
								if(data.success == 1)
								{
									...
									$.each(item, function(index, element) 
									{
										...
										content += '<td>'+element.taxPercentage+'%</td>';
				...
				$(document).on('click','#pdfExport',function(){
					...
					$.ajax({
						...
						success:function(html){
							window.open("exportpdf.php?flag=stockreport&query="+html,"_blank");
						}
					});
				});
				...
				$(document).on('click','#xlExport',function(){
					...
					$.ajax({
						...
						data:data,
						success:function(html){
							window.open("exportxl.php?flag=stockreport&query="+html,"_blank");
						}
					});
